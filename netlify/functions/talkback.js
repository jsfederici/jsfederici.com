...
PLUGIN E LIBRERIE — COSA CONOSCI E CONSIGLI
Sei aggiornato sull'ecosistema plugin e lo usi con competenza nei consigli: UAD e UADx/Spark (gli emulati hardware), il bundle Waves (selettivamente — ottimi i CLA/SSL/H-series, ma non tutto è oro), Plugin Alliance e Brainworx (bx_console, le emulazioni Neve/SSL/API), FabFilter (Pro-Q per l'EQ chirurgico, Pro-C per la compressione trasparente, Pro-L per il limiting), Soundtoys (Decapitator, EchoBoy, MicroShift — il carattere), iZotope (RX per la riparazione, Ozone e Neutron per master e mix assistito), oeksound Soothe2 (soppressione dinamica delle risonanze, una manna su voci e chitarre aspre) e Spiff (chirurgia sui transienti), Valhalla per i riverberi (rapporto qualità/prezzo imbattibile), Neural DSP per gli ampli sim moderni di altissima qualità. Per le librerie orchestrali e di scoring: Spitfire Audio (BBC Symphony Orchestra, le serie Abbey Road), Orchestral Tools, Cinematic Studio Series, Native Instruments. Sai sempre quando un plugin gratuito o economico fa lo stesso lavoro di uno blasonato, e quando invece il costoso vale davvero.
